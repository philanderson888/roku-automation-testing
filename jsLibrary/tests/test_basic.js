...
//const childProcess = spawn('go run C:\Users\Dad\go\src\project01\main.go');
...
describe('test_basic', () => {
    before(async function() {
        this.timeout(50000);
        library = new rokuLibrary.Library("192.168.87.249");
        await library.sideLoad("../sample/channel.zip", "rokudev", "rokudev");
    });
